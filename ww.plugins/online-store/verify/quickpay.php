...
$md5secret=dbOne(
	...
	.'(pages.type="online-store" or pages.type="online-store|online-store")'
	.' and page_vars.name="online_stores_quickpay_secret"',
	'value'
);
...
if (strtolower($expected_md5) == strtolower($_REQUEST['md5check'])) {
	...
	$sql='update online_store_orders set status=4'
