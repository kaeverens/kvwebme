...
/**
 * frontend/theme-upload.php, KV-Webme Themes Repository
 *
 * processes themes which are uploaded via jquery/ajax
 *
 ...
 */
dbQuery( 'insert into themes_api values (
        "",
        "' . $name . '", 
        "' . $author . '", 
        "' . $description . '", 
...
move_uploaded_file( $_FILES[ 'theme-zip' ][ 'tmp_name' ], $dir . $last_id . '/' . $new_file_name );
