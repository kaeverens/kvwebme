...
/**
 * admin/approve-theme.php, KV-Webme Themes Repository
 *
 ...
 */
shell_exec( 'cp -R ' . USERBASE . 'f/themes_api/themes/' . $theme_id . '/' . $theme_id . '.zip ' . USERBASE . 'themes-personal' );
 ...
 */
$body = ' 
<h3>Theme Approved</h3>
<p>Hi ' . $user[ 'name' ] . ',</p>
<p>Your theme named "' . $theme_name . '" has been approved by moderaters for addition to the theme repository.</p>
<p>Thanks<br/>---<br/>
KvWebme</p>
';

send_mail( $user[ 'email' ], 'noreply@' . $_SERVER[ 'HTTP_HOST' ], 'Theme Approved', $body, false );
