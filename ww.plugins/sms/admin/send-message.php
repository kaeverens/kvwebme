...
echo '<table id="sms-send-table">'
	...
	.'<td><div id="sms_single"><input id="sms_to" value="phone" /> <input id="sms_to_name" value="name (optional)" /> <a href="javascript:sms_choose_from_subscribers()">choose from subscribers</a></div>'
	.'<select style="display:none" id="sms_addressbook_id"><option value="0"> -- choose -- </option>';
...
?>
<p>If you use the code <code>[NAME]</code> in the message, it will be automatically replaced with the recipient's name before sending.</p>
